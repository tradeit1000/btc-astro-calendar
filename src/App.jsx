...
MAR:{l:"March",e:[
  {w:"Mar 03",t:"e",bias:"turn",src:"NASA — Total Lunar Eclipse + Pesavento (730+61 cycles)",
   ...
   why:"Pesavento Moon vs Sign (QE-era, 61 cycles): Virgo = absolute peak. Full Moon = peak signal in bull markets. In the Ides of March BEARISH seasonal context, Full Moon polarity INVERTS = marks a LOW instead of a peak. The Moon in Virgo at a Full Moon in a bearish context becomes: the absolute peak of the bearish pressure = the LOW point. Combined with Total Lunar Eclipse (maximum emotional intensity) this inversion at maximum amplitude = a potentially very significant bottom. Jensen: double eclipse windows mark major trend direction. This eclipse may mark the low of the Ides of March decline and the launching point for the pre-Spring Equinox recovery."},
