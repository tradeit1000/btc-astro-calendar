...
JAN:{l:"January",e:[
  ...
  {w:"Jan 18",t:"n",bias:"turn",src:"Pesavento (2015) — 1,583 cycle study",
   e:"New Moon — Bottom Signal",
   c:"New Moon = market bottom signal per Pesavento's 1,583-cycle study.",
   why:"Pesavento: across 1,583 lunar cycles (1885–2013), New Moon consistently marks market bottoms in bull markets. Average bottom: 1 day BEFORE New Moon. Context: early in Ides of March bearish window."},
...
FEB:{l:"February",e:[
  ...
  {w:"Feb 17",t:"e",bias:"turn",src:"NASA — confirmed Annular Solar Eclipse",
   ...
   c:"Solar eclipses are powerful regime-change catalysts. Eclipse New Moons produce the most violent impulse moves.",
   why:"Jensen (pp.43–45): 'Eclipses are most intense in their effects where they are visible.' Magnitude formula (5 ÷ distance from Node) determines months of effect. Eclipse New Moons produce the most violent impulse moves of any lunar cycle per Pesavento."},
...
MAR:{l:"March",e:[
  {w:"Mar 03",t:"e",bias:"turn",src:"NASA — Total Lunar Eclipse confirmed",
   ...
   why:"Double eclipse windows (Solar + Lunar within 14–15 days) mark the most significant turning points in Jensen's framework. Total eclipse = maximum magnitude. Double eclipse windows historically define major trend direction for subsequent weeks."},
...
APR:{l:"April",e:[
  {w:"Apr 01",t:"n",bias:"turn",src:"Pesavento (2015) + NASA/JPL",
   e:"Full Moon (Pink Moon) — Emotional Peak Within Bullish Cluster",
   c:"Full Moon = market peak signal. Falls at the heart of the Jupiter-Uranus sextile cluster.",
   why:"Pesavento: Full Moon = emotional peak of the lunar cycle. Within the bullish cluster, this marks a short-term profit-taking zone. Not the end of the bullish move — expect consolidation then continuation."},
  {w:"Apr 06",t:"g",bias:"turn",src:"Gann Master Time Factor",
   e:"📐 Gann 180° — ANNUAL MIDPOINT ⚡ 1+8+0=9",
   c:"Exactly 182.6 days from ATH. Gann's most critical angular milestone. Market must reverse or accelerate.",
   why:"Gann: 180° = maximum pressure point. 1+8+0=9 confirms numerological framework. The angular midpoint demands resolution. Given the bullish cluster surrounding this date, resolution is likely UPWARD."},
  ...
  {w:"Apr 20",t:"m",bias:"bear",src:"Jensen (1978) + JPL geocentric + AstrologyKing confirmed",
   e:"☿ Mercury CONJUNCT Saturn (0.681°) — BEARISH — Book of Han: Defeat of an Army",
   c:"Mercury conjuncts Saturn. Geocentric date April 20 confirmed by AstrologyKing. Ancient text: 'signifies the defeat of an army. War should not be undertaken.'",
   why:"From Book of Han (Vol.26, 111 CE): 'Mercury conjunct Saturn results in stagnation and depression. It signifies the defeat of an army. War should not be undertaken.' Modern application: Mercury (communication/narrative) meets Saturn (restriction/reality) = market narrative absorbs maximum contraction. Business dealings requiring sustained concentration are favored — but market direction is suppressed. Date confirmed geocentrically via AstrologyKing and JPL (0.681° orb, Apr 20). Falls within 'Sell in May' bearish seasonal."},
  {w:"Apr 21",t:"m",bias:"bear",src:"Jensen (1978) + JPL geocentric",
   e:"☿ Mercury CONJUNCT Mars (0.076°) — Near-Exact Aggressive Narrative",
   c:"Mercury meets Mars at near-exact 0.076° orb. The day after Mercury CONJ Saturn — aggression follows restriction.",
   why:"0.076° = near-exact. Mercury (narrative) + Mars (aggression) = aggressive market communication. Falls 1 day after Mercury CONJ Saturn (Apr 20) — the sequence: narrative restriction (Saturn) immediately followed by narrative aggression (Mars). Sharp aggressive move within the existing bearish trend."},
...
MAY:{l:"May",e:[
  {w:"May 01",t:"n",bias:"turn",src:"Pesavento (2015)",
   e:"Full Moon (Flower Moon — Apogee/Micromoon)",
   c:"Full Moon peak signal. Apogee = reduced emotional amplification vs typical Full Moon.",
   why:"Pesavento: Full Moon = emotional peak. At apogee (maximum distance), the signal is present but less intense. Within 'Sell in May' — this peak likely marks a short-term high before continued decline."},
  ...
  {w:"May 22",t:"g",bias:"turn",src:"Gann Master Time Factor",
   e:"📐 Gann 225° (228.3d from ATH) — 2+2+5=9",
   c:"Fifth 45° angular milestone from ATH. 2+2+5=9.",
   why:"Gann's angular method continues: 225° = fifth step around the annual cycle wheel."},
...
JUN:{l:"June",e:[
  ...
  {w:"Jun 15",t:"g",bias:"turn",src:"Pesavento (730 cycles) + Jensen + Gann + NASA/JPL",
   ...
   c:"Five independent frameworks on one date. Moon in Gemini = ABSOLUTE LOW per Pesavento (730 S&P cycles).",
   why:"(1) Pesavento 730-cycle Moon vs Sign: Gemini = strongest absolute lows. (2) New Moon = bottom signal (avg NM −1 day). (3) Mercury Greatest Elongation 24.5°E = max clarity. (4) Gann 4×9w (2+5+2=9). (5) Moon Perigee Jun 14 (357km) for amplification. The highest-confidence bottom signal of 2026."},
...
JUL:{l:"July",e:[
  ...
  {w:"Jul 12",t:"m",bias:"bull",src:"NASA/JPL verified",
   e:"☿ Mercury Cazimi in Cancer + Declination Plateau +17.05° (delta 0.05°)",
   c:"Second Cazimi of the year. Brief clarity window within retrograde. Declination is a plateau, not a sharp peak.",
   why:"Mercury Cazimi: within 17 arcminutes of Sun's center = maximum clarity during retrograde. The +17.05° declination with 0.05° delta = essentially stationary in declination (a plateau, not a peak). Original source incorrectly labeled this a 'peak' — it is a near-flat local minimum."},
...
NOV:{l:"November",e:[
  ...
  {w:"Nov 09",t:"g",bias:"bull",src:"Jensen (1978) + Pesavento (2015)",
   ...
   why:"Jensen: Jupiter is the primary bullish financial planet. Its synodic period (399 days) marks major structural shifts. This 399-day cycle close from the ATH + New Moon bottom signal = potentially significant low — first major bullish signal after the Fall Crash Zone."},
...
DEC:{l:"December",e:[
  ...
  {w:"Dec 08",t:"m",bias:"turn",src:"JPL geocentric",
   ...
   c:"Mercury opposes Uranus at 0.671° orb on the last day of the Santa Claus Rally. Sudden unexpected news as the rally closes.",
...
CONF:{l:"Confluences ⭐",e:[
  ...
  {w:"METHODOLOGY",t:"g",bias:"neut",src:"Jensen (1978) + Gann methodology",
   ...
   c:"All Mercury/Venus aspects in this calendar use GEOCENTRIC coordinates (standard financial astrology). Mars Helio uses heliocentric (Gann squaring framework). These are intentionally different systems.",
   why:"Financial astrology (Jensen, Pesavento, Bayer) uses geocentric coordinates — planetary positions as seen from Earth. Gann's 'squaring price with planets' uses heliocentric positions for the geometric angle calculations. Mixing these two systems produces wrong dates — the primary error corrected in this version of the calendar. Geocentric aspects confirmed via JPL ephemeris and AstrologyKing cross-reference."},
  ...
  {w:"Sep 24",t:"g",bias:"bull",src:"Jensen (1978) p.69 + Gann + NASA/JPL",
   ...
   why:"Jensen's 1974 case study: 'A trine during a bearish Node configuration produced the framework of a classic low and a recovery of at least 15-18 months.' This is the closest historical parallel to 2026. September-October may produce the MAJOR LOW of 2026 here."},
