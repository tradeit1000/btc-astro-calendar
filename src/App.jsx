...
,
  {w:"Jul 03",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 270° do ATH (SH1)",c:"270° = ⅜ do ciclo anual desde ATH. Turning point maior.",why:"270° = ⅜ do ciclo anual desde ATH. Turning point maior."},
  {w:"Jul 04",t:"m",bias:"warn",src:"Multi-framework",e:"Marte ☌ Urano exact + Marte △ Plutão",c:"Disrupção + poder transformador. Volatilidade elevada.",why:"Disrupção + poder transformador. Volatilidade elevada."},
  {w:"Jul 06",t:"m",bias:"warn",src:"Multi-framework",e:"☀️ Sol □ Saturno 0.05°",c:"Realidade dura. Pressão descendente sazonal Sell in May end.",why:"Realidade dura. Pressão descendente sazonal Sell in May end."},
  {w:"Jul 12",t:"g",bias:"info",src:"Gann Time Angles",e:"📐 Gann 135° do LOW $60,001",c:"Turning point secundário.",why:"Turning point secundário."},
  {w:"Jul 13",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 180° do SH2 Jan",c:"180° = ponto de máximo stress temporal do swing high de Jan.",why:"180° = ponto de máximo stress temporal do swing high de Jan."},
  {w:"Jul 14",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Caranguejo 23°",c:"Signo Caranguejo = Lua/Cancer = número 69 Tunnel Gann.",why:"Signo Caranguejo = Lua/Cancer = número 69 Tunnel Gann."},
  {w:"Jul 20-25",t:"m",bias:"warn",src:"JPL ephem",e:"⚡⚡⚡ SUPER-CLUSTER Júpiter-Úrano-Neptuno-Plutão",c:"EVENTO MAIOR DE 2026 pós-Bottleneck Abril: Júpiter△Neptuno + Júpiter☍Plutão + Júpiter⚹Úrano + Úrano⚹Neptuno + Úrano△Plutão + Neptuno⚹Plutão TODOS exactos. Reconfiguração estrutural. Máximo bullish OU ",why:"EVENTO MAIOR DE 2026 pós-Bottleneck Abril: Júpiter△Neptuno + Júpiter☍Plutão + Júpiter⚹Úrano + Úrano⚹Neptuno + Úrano△Plutão + Neptuno⚹Plutão TODOS exactos. Reconfiguração estrutural. Máximo bullish OU máximo bearish dependendo do preço no momento."},
  {w:"Jul 30",t:"n",bias:"info",src:"Multi-framework",e:"🌕 LC Aquário 17°",c:"Fim ciclo lunar. Sell in May terminou 26 Jun, agora Summer Rally deve estar activo.",why:"Fim ciclo lunar. Sell in May terminou 26 Jun, agora Summer Rally deve estar activo."}]},
...
,
  {w:"Aug 05",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 180° SL2 Feb (Swing Low $92K)",c:"180° do swing low = ponto de máximo stress.",why:"180° do swing low = ponto de máximo stress."},
  {w:"Aug 13",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Virgem 1°",c:"Virgem = Peak QE Pesavento. Em bear inverso = LOW possível.",why:"Virgem = Peak QE Pesavento. Em bear inverso = LOW possível."},
  {w:"Aug 17",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 315° do ATH",c:"315° = 7/8 do ciclo anual. Preparação para 360° em Out.",why:"315° = 7/8 do ciclo anual. Preparação para 360° em Out."},
  {w:"Aug 26",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 180° do LOW $60,001",c:"Extremamente significativo. 180° do LOW absoluto.",why:"Extremamente significativo. 180° do LOW absoluto."},
  {w:"Aug 27",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 225° do SH2 Jan",c:"Confluência com Gann 180° LOW no dia anterior.",why:"Confluência com Gann 180° LOW no dia anterior."},
  {w:"Aug 28",t:"n",bias:"info",src:"Multi-framework",e:"🌕 LC Peixes 9°",c:"Confusão/dissolução narrativa.",why:"Confusão/dissolução narrativa."}]},
...
,
  {w:"Sep 04",t:"g",bias:"warn",src:"Gann Time Angles",e:"⭐⭐⭐ RALLY TOP FIXED — ATH+333 = LOW+189 = 3×63 Gann",c:"DATA FIXA. Exit all longs. Preparação Fall Crash Zone.",why:"DATA FIXA. Exit all longs. Preparação Fall Crash Zone."},
  {w:"Sep 11",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Virgem 23° (QE Peak inversion)",c:"Virgem = peak QE. Em bear = TOPO local. Confirma exit.",why:"Virgem = peak QE. Em bear = TOPO local. Confirma exit."},
  {w:"Sep 16",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 345° do ATH",c:"15° antes de completar ciclo anual.",why:"15° antes de completar ciclo anual."},
  {w:"Sep 19",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 225° do SL2 Feb",c:"Preparação Fall Crash.",why:"Preparação Fall Crash."},
  {w:"Sep 27",t:"n",bias:"info",src:"Multi-framework",e:"🌕 LC Áries 15°",c:"Áries = Marte = agressividade. Full Moon = topo em bear.",why:"Áries = Marte = agressividade. Full Moon = topo em bear."}]},
...
,
  {w:"Oct 01",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 360° do ATH — Ciclo Anual Completo",c:"1 ano exacto desde ATH. Ponto de reset maior.",why:"1 ano exacto desde ATH. Ponto de reset maior."},
  {w:"Oct 02",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 315° SL1 Nov (Swing Low)",c:"📐 Gann 315° SL1 Nov (Swing Low)",why:"Multi-framework signal."},
  {w:"Oct 06",t:"m",bias:"warn",src:"Tunnel Gann",e:"⭐⭐⭐ MARIE STANTON BIRTHDAY — 1 ano do ATH",c:"Tunnel Gann: \'Fim da fase Marie = topo do mercado\'. 1 ano exacto.",why:"Tunnel Gann: \'Fim da fase Marie = topo do mercado\'. 1 ano exacto."},
  {w:"Oct 07-10",t:"n",bias:"warn",src:"Multi-framework confluence",e:"⚠️⚠️⚠️ FALL CRASH ZONE — Perigee max force lag 0d + K of Hearts #9 + LN Balança",c:"JANELA DE CRASH CONFIRMADA por 3 frameworks. Alvo $35-44K cycle bottom.",why:"JANELA DE CRASH CONFIRMADA por 3 frameworks. Alvo $35-44K cycle bottom."},
  {w:"Oct 11",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Balança 28°",c:"Balança = valores em equilíbrio quebrado.",why:"Balança = valores em equilíbrio quebrado."},
  {w:"Oct 20",t:"m",bias:"warn",src:"Multi-framework",e:"Vénus □ Plutão exact",c:"Valores destruídos/transformados.",why:"Valores destruídos/transformados."},
  {w:"Oct 26",t:"m",bias:"warn",src:"Multi-framework",e:"☀️ Sol □ Plutão 0.00° EXACTO",c:"Crise estrutural absoluta. Precisão rara.",why:"Crise estrutural absoluta. Precisão rara."}]},
...
,
  {w:"Nov 04",t:"m",bias:"info",src:"Multi-framework",e:"♀ Vénus ⚹ Júpiter 0.03° (99 ciclos Pesavento)",c:"Aspecto mais bullish. Se pós Crash Zone = bottom + rally.",why:"Aspecto mais bullish. Se pós Crash Zone = bottom + rally."},
  {w:"Nov 09",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Escorpião 19°",c:"Escorpião = LOW absoluto 730 ciclos Pesavento.",why:"Escorpião = LOW absoluto 730 ciclos Pesavento."},
  {w:"Nov 16",t:"m",bias:"warn",src:"Multi-framework",e:"♂♃ Marte ☌ Júpiter 0.09°",c:"Acção + expansão = arranque bullish forte.",why:"Acção + expansão = arranque bullish forte."},
  {w:"Nov 24",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 270° do LOW $60,001",c:"270° = ⅜ do ciclo anual desde LOW. Turning point.",why:"270° = ⅜ do ciclo anual desde LOW. Turning point."},
  {w:"Nov 28-29",t:"m",bias:"info",src:"Multi-framework",e:"♀ Vénus ⚹ Júpiter EXACTO 0.00° + ♅ Urano △ Plutão",c:"Confluência extrema bullish + generational aspect.",why:"Confluência extrema bullish + generational aspect."}]},
...
,
  {w:"Dec 01-11",t:"m",bias:"info",src:"Multi-framework",e:"⭐⭐⭐ URANO △ PLUTÃO — Aspecto Generacional",c:"Ambos exactos 29 Nov 0.01°. Generational shift. Última vez foi 1922. Reset estrutural completo.",why:"Ambos exactos 29 Nov 0.01°. Generational shift. Última vez foi 1922. Reset estrutural completo."},
  {w:"Dec 04",t:"m",bias:"warn",src:"Multi-framework",e:"♂♅ Marte □ Urano 0.12°",c:"Disrupção. Volatilidade.",why:"Disrupção. Volatilidade."},
  {w:"Dec 09",t:"n",bias:"info",src:"Multi-framework",e:"🌑 LN Sagitário 22°",c:"Sagitário = optimismo. Bear inversion = topo local.",why:"Sagitário = optimismo. Bear inversion = topo local."},
  {w:"Dec 18",t:"g",bias:"warn",src:"Gann Time Angles",e:"📐 Gann 315° SL2 Feb + Solstício Inverno",c:"315° do swing low + solstício = ponto astro-time major.",why:"315° do swing low + solstício = ponto astro-time major."},
  {w:"Dec 23",t:"m",bias:"warn",src:"Multi-framework",e:"☀️ Sol □ Neptuno 0.02°",c:"Precisão rara. Confusão máxima end of year.",why:"Precisão rara. Confusão máxima end of year."},
  {w:"Dec 25",t:"g",bias:"info",src:"Gann Time Angles",e:"📐 Gann 345° SH2 Jan",c:"📐 Gann 345° SH2 Jan",why:"Multi-framework signal."},
  {w:"Dec 29-30",t:"m",bias:"warn",src:"Multi-framework",e:"☀️ Sol □ Saturno + ☿ □ Saturno",c:"Duplo bearish end of year.",why:"Duplo bearish end of year."}]},
...
const LOCAL_TRENDS = [
  ...
  {d:"Jan 01",b:"bear",l:"☿ Merc Square Neptuno",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Neptuno (ilusão/confusão). tensão — acção forçada. orb 0.094°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 04",b:"conf",l:"📐 Gann 90° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 90° do ATH Oct 6 ($126,272). Ângulo de 90° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Jan 05",b:"key",l:"📐 Gann 45° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 45° do Swing Low Nov 21 ($92,000). Ângulo de 45° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Jan 14",b:"bear",l:"☿ Merc Oposição Júpiter",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) oposição Júpiter (expansão/optimismo). confronto — polaridade máxima. orb 0.282°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 18",b:"bear",l:"☿ Merc Conjunção Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Marte (acção/agressividade). fusão de energias — começo de ciclo. orb 0.157°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 19",b:"bull",l:"☿ Merc Trine Urano",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Urano (surpresa/disrupção). fluxo fácil — favorável. orb 0.453°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 20",b:"bull",l:"☿ Merc Sextil Neptuno",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Neptuno (ilusão/confusão). cooperação — oportunidade. orb 0.174°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 22",b:"neut",l:"☿ Merc Conjunção Plutão",dir:"🟡 WATCH",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) conjunção Plutão (poder/transformação). fusão de energias — começo de ciclo. orb 0.360°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 29",b:"neut",l:"☿ Merc Conjunção Vénus",dir:"🟡 WATCH",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) conjunção Vénus (valor/finanças). fusão de energias — começo de ciclo. orb 0.035°.",seas:"Mercúrio Aspectos"},
  {d:"Jan 30",b:"neut",l:"☿ Merc Conjunção Vénus",dir:"🟡 WATCH",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) conjunção Vénus (valor/finanças). fusão de energias — começo de ciclo. orb 0.535°.",seas:"Mercúrio Aspectos"},
  {d:"Feb 05",b:"bear",l:"☿ Merc Square Urano",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Urano (surpresa/disrupção). tensão — acção forçada. orb 0.009°.",seas:"Mercúrio Aspectos"},
  {d:"Feb 16",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.542°.",seas:"Mercúrio Aspectos"},
  {d:"Feb 17",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.821°.",seas:"Mercúrio Aspectos"},
  {d:"Feb 18",b:"key",l:"📐 Gann 135° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 135° do ATH Oct 6 ($126,272). Ângulo de 135° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Feb 19",b:"conf",l:"📐 Gann 90° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 90° do Swing Low Nov 21 ($92,000). Ângulo de 90° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Feb 28",b:"key",l:"📐 Gann 45° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 45° do Swing High Jan 14 ($105,000). Ângulo de 45° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Feb 28",b:"neut",l:"☿ Merc Conjunção Vénus",dir:"🟡 WATCH",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) conjunção Vénus (valor/finanças). fusão de energias — começo de ciclo. orb 0.422°.",seas:"Mercúrio Aspectos"},
  {d:"Mar 09",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.266°.",seas:"Mercúrio Aspectos"},
  {d:"Mar 15",b:"bear",l:"☿ Merc Conjunção Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Marte (acção/agressividade). fusão de energias — começo de ciclo. orb 0.217°.",seas:"Mercúrio Aspectos"},
  {d:"Mar 23",b:"key",l:"📐 Gann 45° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 45° do Swing Low Feb 6 ($92,000). Ângulo de 45° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Apr 03",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.025°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 04",b:"conf",l:"📐 Gann 180° de SH1 (ATH Oct 6)",dir:"🔴 SHORT",prob:"ALTA",note:"Gann 180° do ATH Oct 6 ($126,272). Ângulo de 180° a partir de swing HIGH — possível turning point descendente. 180° do ATH = ponto de máximo stress temporal.",seas:"Gann Time"},
  {d:"Apr 04",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.947°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 05",b:"key",l:"📐 Gann 135° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 135° do Swing Low Nov 21 ($92,000). Ângulo de 135° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Apr 13",b:"key",l:"📐 Gann 45° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 45° do LOW absoluto Feb 27 ($60,001). Ângulo de 45° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Apr 14",b:"conf",l:"📐 Gann 90° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 90° do Swing High Jan 14 ($105,000). Ângulo de 90° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Apr 14",b:"bull",l:"☿ Merc Sextil Urano",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Urano (surpresa/disrupção). cooperação — oportunidade. orb 0.288°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 17",b:"bear",l:"☿ Merc Conjunção Neptuno",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Neptuno (ilusão/confusão). fusão de energias — começo de ciclo. orb 0.597°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 18",b:"bull",l:"☿ Merc Sextil Plutão",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Plutão (poder/transformação). cooperação — oportunidade. orb 0.530°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 19",b:"bull",l:"☿ Merc Sextil Plutão",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Plutão (poder/transformação). cooperação — oportunidade. orb 0.983°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 20",b:"bear",l:"☿ Merc Conjunção Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Marte (acção/agressividade). fusão de energias — começo de ciclo. orb 0.324°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 21",b:"bear",l:"☿ Merc Conjunção Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Marte (acção/agressividade). fusão de energias — começo de ciclo. orb 0.482°.",seas:"Mercúrio Aspectos"},
  {d:"Apr 26",b:"bear",l:"☿ Merc Square Júpiter",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Júpiter (expansão/optimismo). tensão — acção forçada. orb 0.436°.",seas:"Mercúrio Aspectos"},
  {d:"May 05",b:"bear",l:"☿ Merc Square Plutão",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Plutão (poder/transformação). tensão — acção forçada. orb 0.836°.",seas:"Mercúrio Aspectos"},
  {d:"May 07",b:"conf",l:"📐 Gann 90° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 90° do Swing Low Feb 6 ($92,000). Ângulo de 90° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"May 13",b:"bull",l:"☿ Merc Sextil Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Júpiter (expansão/optimismo). cooperação — oportunidade. orb 0.611°.",seas:"Mercúrio Aspectos"},
  {d:"May 19",b:"key",l:"📐 Gann 225° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 225° do ATH Oct 6 ($126,272). Ângulo de 225° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"May 19",b:"bull",l:"☿ Merc Sextil Neptuno",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Neptuno (ilusão/confusão). cooperação — oportunidade. orb 0.708°.",seas:"Mercúrio Aspectos"},
  {d:"May 19",b:"bull",l:"☿ Merc Trine Plutão",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Plutão (poder/transformação). fluxo fácil — favorável. orb 0.970°.",seas:"Mercúrio Aspectos"},
  {d:"May 20",b:"conf",l:"📐 Gann 180° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 180° do Swing Low Nov 21 ($92,000). Ângulo de 180° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"May 28",b:"conf",l:"📐 Gann 90° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 90° do LOW absoluto Feb 27 ($60,001). Ângulo de 90° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"May 29",b:"key",l:"📐 Gann 135° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 135° do Swing High Jan 14 ($105,000). Ângulo de 135° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Jun 04",b:"bear",l:"☿ Merc Square Neptuno",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Neptuno (ilusão/confusão). tensão — acção forçada. orb 0.757°.",seas:"Mercúrio Aspectos"},
  {d:"Jun 19",b:"bull",l:"☿ Merc Sextil Marte",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Marte (acção/agressividade). cooperação — oportunidade. orb 0.957°.",seas:"Mercúrio Aspectos"},
  {d:"Jun 20",b:"bull",l:"☿ Merc Sextil Marte",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Marte (acção/agressividade). cooperação — oportunidade. orb 0.973°.",seas:"Mercúrio Aspectos"},
  {d:"Jun 21",b:"key",l:"📐 Gann 135° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 135° do Swing Low Feb 6 ($92,000). Ângulo de 135° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Jul 03",b:"conf",l:"📐 Gann 270° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 270° do ATH Oct 6 ($126,272). Ângulo de 270° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Jul 04",b:"key",l:"📐 Gann 225° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 225° do Swing Low Nov 21 ($92,000). Ângulo de 225° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Jul 12",b:"key",l:"📐 Gann 135° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 135° do LOW absoluto Feb 27 ($60,001). Ângulo de 135° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Jul 13",b:"conf",l:"📐 Gann 180° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 180° do Swing High Jan 14 ($105,000). Ângulo de 180° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Jul 24",b:"bull",l:"☿ Merc Sextil Vénus",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Vénus (valor/finanças). cooperação — oportunidade. orb 0.178°.",seas:"Mercúrio Aspectos"},
  {d:"Jul 25",b:"bull",l:"☿ Merc Sextil Vénus",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Vénus (valor/finanças). cooperação — oportunidade. orb 0.789°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 05",b:"conf",l:"📐 Gann 180° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 180° do Swing Low Feb 6 ($92,000). Ângulo de 180° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Aug 12",b:"bull",l:"☿ Merc Trine Neptuno",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Neptuno (ilusão/confusão). fluxo fácil — favorável. orb 0.624°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 12",b:"bull",l:"☿ Merc Sextil Urano",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Urano (surpresa/disrupção). cooperação — oportunidade. orb 0.635°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 12",b:"bear",l:"☿ Merc Oposição Plutão",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) oposição Plutão (poder/transformação). confronto — polaridade máxima. orb 0.799°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 13",b:"bull",l:"☿ Merc Sextil Vénus",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Vénus (valor/finanças). cooperação — oportunidade. orb 0.153°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 14",b:"bull",l:"☿ Merc Sextil Vénus",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Vénus (valor/finanças). cooperação — oportunidade. orb 0.716°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 15",b:"bull",l:"☿ Merc Conjunção Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) conjunção Júpiter (expansão/optimismo). fusão de energias — começo de ciclo. orb 0.043°.",seas:"Mercúrio Aspectos"},
  {d:"Aug 17",b:"key",l:"📐 Gann 315° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 315° do ATH Oct 6 ($126,272). Ângulo de 315° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Aug 18",b:"conf",l:"📐 Gann 270° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 270° do Swing Low Nov 21 ($92,000). Ângulo de 270° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Aug 26",b:"conf",l:"📐 Gann 180° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 180° do LOW absoluto Feb 27 ($60,001). Ângulo de 180° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Aug 27",b:"key",l:"📐 Gann 225° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 225° do Swing High Jan 14 ($105,000). Ângulo de 225° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Aug 28",b:"bear",l:"☿ Merc Square Urano",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Urano (surpresa/disrupção). tensão — acção forçada. orb 0.377°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 01",b:"bull",l:"☿ Merc Sextil Marte",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Marte (acção/agressividade). cooperação — oportunidade. orb 0.067°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 12",b:"bear",l:"☿ Merc Oposição Neptuno",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) oposição Neptuno (ilusão/confusão). confronto — polaridade máxima. orb 0.314°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 12",b:"bull",l:"☿ Merc Trine Plutão",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Plutão (poder/transformação). fluxo fácil — favorável. orb 0.265°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 14",b:"bull",l:"☿ Merc Trine Urano",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Urano (surpresa/disrupção). fluxo fácil — favorável. orb 0.641°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 16",b:"key",l:"📐 Gann 345° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Gann 345° do ATH Oct 6 ($126,272). Ângulo de 345° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Sep 19",b:"key",l:"📐 Gann 225° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 225° do Swing Low Feb 6 ($92,000). Ângulo de 225° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Sep 21",b:"bull",l:"☿ Merc Sextil Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Júpiter (expansão/optimismo). cooperação — oportunidade. orb 0.588°.",seas:"Mercúrio Aspectos"},
  {d:"Sep 22",b:"bull",l:"☿ Merc Sextil Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) sextil Júpiter (expansão/optimismo). cooperação — oportunidade. orb 0.711°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 01",b:"conf",l:"📐 Gann 360° de SH1 (ATH Oct 6)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 360° do ATH Oct 6 ($126,272). Ângulo de 360° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Oct 02",b:"key",l:"📐 Gann 315° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 315° do Swing Low Nov 21 ($92,000). Ângulo de 315° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Oct 02",b:"bear",l:"☿ Merc Square Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Marte (acção/agressividade). tensão — acção forçada. orb 0.085°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 02",b:"bear",l:"☿ Merc Square Plutão",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Plutão (poder/transformação). tensão — acção forçada. orb 0.460°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 03",b:"bear",l:"☿ Merc Square Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Marte (acção/agressividade). tensão — acção forçada. orb 0.788°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 03",b:"bear",l:"☿ Merc Square Plutão",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Plutão (poder/transformação). tensão — acção forçada. orb 0.827°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 07",b:"neut",l:"☿ Merc Conjunção Vénus",dir:"🟡 WATCH",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) conjunção Vénus (valor/finanças). fusão de energias — começo de ciclo. orb 0.654°.",seas:"Mercúrio Aspectos"},
  {d:"Oct 10",b:"key",l:"📐 Gann 225° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 225° do LOW absoluto Feb 27 ($60,001). Ângulo de 225° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Oct 11",b:"conf",l:"📐 Gann 270° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"ALTA",note:"Gann 270° do Swing High Jan 14 ($105,000). Ângulo de 270° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Oct 30",b:"bear",l:"☿ Merc Square Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Marte (acção/agressividade). tensão — acção forçada. orb 0.324°.",seas:"Mercúrio Aspectos"},
  {d:"Nov 01",b:"key",l:"📐 Gann 345° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Gann 345° do Swing Low Nov 21 ($92,000). Ângulo de 345° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Nov 03",b:"conf",l:"📐 Gann 270° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 270° do Swing Low Feb 6 ($92,000). Ângulo de 270° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Nov 16",b:"conf",l:"📐 Gann 360° de SL1 (Swing Low Nov 21)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 360° do Swing Low Nov 21 ($92,000). Ângulo de 360° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Nov 24",b:"conf",l:"📐 Gann 270° de SL3 (LOW absoluto Feb 27)",dir:"🟢 WATCH LONG",prob:"ALTA",note:"Gann 270° do LOW absoluto Feb 27 ($60,001). Ângulo de 270° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Nov 25",b:"key",l:"📐 Gann 315° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Gann 315° do Swing High Jan 14 ($105,000). Ângulo de 315° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Dec 04",b:"bear",l:"☿ Merc Square Júpiter",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) square Júpiter (expansão/optimismo). tensão — acção forçada. orb 0.310°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 07",b:"bull",l:"☿ Merc Trine Neptuno",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) trine Neptuno (ilusão/confusão). fluxo fácil — favorável. orb 0.117°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 08",b:"bear",l:"☿ Merc Oposição Urano",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) oposição Urano (surpresa/disrupção). confronto — polaridade máxima. orb 0.110°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 08",b:"bull",l:"☿ Merc Sextil Plutão",dir:"🟢 WATCH LONG",prob:"BAIXA",note:"Mercúrio (narrativa/notícias) sextil Plutão (poder/transformação). cooperação — oportunidade. orb 0.467°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 09",b:"bear",l:"☿ Merc Square Marte",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Marte (acção/agressividade). tensão — acção forçada. orb 0.078°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 18",b:"key",l:"📐 Gann 315° de SL2 (Swing Low Feb 6)",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Gann 315° do Swing Low Feb 6 ($92,000). Ângulo de 315° a partir de swing LOW — possível turning point ascendente.",seas:"Gann Time"},
  {d:"Dec 23",b:"bull",l:"☿ Merc Trine Júpiter",dir:"🟢 WATCH LONG",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) trine Júpiter (expansão/optimismo). fluxo fácil — favorável. orb 0.395°.",seas:"Mercúrio Aspectos"},
  {d:"Dec 25",b:"key",l:"📐 Gann 345° de SH2 (Swing High Jan 14)",dir:"🔴 WATCH SHORT",prob:"BAIXA",note:"Gann 345° do Swing High Jan 14 ($105,000). Ângulo de 345° a partir de swing HIGH — possível turning point descendente.",seas:"Gann Time"},
  {d:"Dec 26",b:"bear",l:"☿ Merc Square Neptuno",dir:"🔴 WATCH SHORT",prob:"MÉDIA",note:"Mercúrio (narrativa/notícias) square Neptuno (ilusão/confusão). tensão — acção forçada. orb 0.504°.",seas:"Mercúrio Aspectos"},
  {d:"Mai 22",b:"conf",l:"⭐ HOJE: Sol☌Urano + Vénus□Neptuno + Mercúrio⚹Saturno",dir:"🟡 WATCH",prob:"ALTA",note:"Cluster de alta volatilidade. Sol☌Urano quase exacto (0.09°) = disrupção/surpresa. Vénus□Neptuno = activos sobrevalorizados. BTC $77,400 dentro do range distributivo Wyckoff.",seas:"Sell in May"},
  {d:"Mai 26",b:"conf",l:"⭐ Marte □ Plutão 0.26° + Sol △ Plutão",dir:"🔴 SHORT",prob:"ALTA",note:"O aspecto mais violento do mês. Força irresistível vs objecto imóvel. Descarga bearish provável. Watch break de $76,569 (108/144).",seas:"Sell in May"},
  {d:"Mai 28",b:"conf",l:"📐 Gann 90° do LOW absoluto $60,001",dir:"🔴 SHORT",prob:"MÉDIA",note:"90 dias exactos do LOW. Ângulo Gann 1ª ordem = turning point OU aceleração. Em contexto bearish activo, aceleração é mais provável.",seas:"Sell in May"},
  {d:"Mai 29",b:"key",l:"Vénus □ Saturno + Gann 135° SH2",dir:"🔴 SHORT",prob:"MÉDIA",note:"Duplo: aspecto Vénus□Saturno (valores contraídos) + Gann 135° do swing high de Janeiro. Final da janela bearish de Maio.",seas:"Sell in May"},
  {d:"Jun 09",b:"conf",l:"⭐⭐ VÉNUS ☌ JÚPITER 20:00 UTC (99 ciclos Pesavento)",dir:"🟢 LONG",prob:"ALTA",note:"O ASPECTO MAIS BULLISH da astrologia financeira. Exacto 20:00 UTC. Pesavento: 99 ciclos verificados. Fundo local + início do bounce mid-W. Entry LONG.",seas:"Sell in May"},
  {d:"Jun 15",b:"lnova",l:"🌑 LN Gémeos 02:54 UTC — Pivot 5 frameworks",dir:"🟢 LONG",prob:"ALTA",note:"LN em Gémeos exacta. Pesavento 730 ciclos. Gémeos = signo de Úrano. Vénus⚹Urano simultâneo. Confirmação de reversão para cima.",seas:"Sell in May"},
  {d:"Jun 21",b:"key",l:"📐 Gann 135° SL2 + Solstício Verão",dir:"🟡 WATCH",prob:"MÉDIA",note:"135° do swing low Feb 6 + Solstício. Turning point potencial. Reversão para o segundo pé do W-formation.",seas:"Sell in May"},
  {d:"Jun 25",b:"conf",l:"⭐ Vénus △ Saturno 0.002° EXACTO ao milésimo",dir:"🟢 LONG",prob:"ALTA",note:"Precisão rara. Valores ganham estrutura sólida. Base para acumulação. Higher low do W-formation.",seas:"Sell in May"},
  {d:"Jun 26",b:"key",l:"Fim Sell in May (Pesavento)",dir:"🟢 LONG",prob:"MÉDIA",note:"Pesavento explicit: 'Sell in May bottoms in early July'. Viés sazonal muda de bearish para neutro/bullish.",seas:"Summer Rally"},
  {d:"Jun 28",b:"key",l:"Marte ⚹ Júpiter 0.15° — Arranque",dir:"🟢 LONG",prob:"MÉDIA",note:"Marte+Júpiter = arranque do próximo ciclo. Confluência com Vénus△Saturno + fim Sell in May.",seas:"Summer Rally"},
  {d:"Jun 30",b:"conf",l:"⭐ Dia 144 swing square + Mercury retro",dir:"🟢 LONG",prob:"ALTA",note:"144 dias exactos do swing low Feb 6. Fecha swing square anchor. Second foot do W-formation. Higher low. Launch do Summer Rally.",seas:"Summer Rally"},
  {d:"Jul 03",b:"key",l:"📐 Gann 270° do ATH (SH1)",dir:"🔴 SHORT",prob:"MÉDIA",note:"270° = ⅜ do ciclo anual desde ATH. Turning point maior.",seas:"H2 2026"},
  {d:"Jul 04",b:"key",l:"Marte ☌ Urano exact + Marte △ Plutão",dir:"🔴 SHORT",prob:"MÉDIA",note:"Disrupção + poder transformador. Volatilidade elevada.",seas:"H2 2026"},
  {d:"Jul 06",b:"key",l:"☀️ Sol □ Saturno 0.05°",dir:"🔴 SHORT",prob:"MÉDIA",note:"Realidade dura. Pressão descendente sazonal Sell in May end.",seas:"H2 2026"},
  {d:"Jul 12",b:"key",l:"📐 Gann 135° do LOW $60,001",dir:"🟡 WATCH",prob:"MÉDIA",note:"Turning point secundário.",seas:"H2 2026"},
  {d:"Jul 13",b:"key",l:"📐 Gann 180° do SH2 Jan",dir:"🔴 SHORT",prob:"MÉDIA",note:"180° = ponto de máximo stress temporal do swing high de Jan.",seas:"H2 2026"},
  {d:"Jul 14",b:"key",l:"🌑 LN Caranguejo 23°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Signo Caranguejo = Lua/Cancer = número 69 Tunnel Gann.",seas:"H2 2026"},
  {d:"Jul 20-25",b:"conf",l:"⚡⚡⚡ SUPER-CLUSTER Júpiter-Úrano-Neptuno-Plutão",dir:"🔴 SHORT",prob:"ALTA",note:"EVENTO MAIOR DE 2026 pós-Bottleneck Abril: Júpiter△Neptuno + Júpiter☍Plutão + Júpiter⚹Úrano + Úrano⚹Neptuno + Úrano△Plutão + Neptuno⚹Plutão TODOS exactos. Reconfiguração estrutural. Máximo bullish OU máximo bearish dependendo do preço no momento.",seas:"H2 2026"},
  {d:"Jul 30",b:"key",l:"🌕 LC Aquário 17°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Fim ciclo lunar. Sell in May terminou 26 Jun, agora Summer Rally deve estar activo.",seas:"H2 2026"},
  {d:"Aug 05",b:"key",l:"📐 Gann 180° SL2 Feb (Swing Low $92K)",dir:"🔴 SHORT",prob:"MÉDIA",note:"180° do swing low = ponto de máximo stress.",seas:"H2 2026"},
  {d:"Aug 13",b:"key",l:"🌑 LN Virgem 1°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Virgem = Peak QE Pesavento. Em bear inverso = LOW possível.",seas:"H2 2026"},
  {d:"Aug 17",b:"key",l:"📐 Gann 315° do ATH",dir:"🔴 SHORT",prob:"MÉDIA",note:"315° = 7/8 do ciclo anual. Preparação para 360° em Out.",seas:"H2 2026"},
  {d:"Aug 26",b:"key",l:"📐 Gann 180° do LOW $60,001",dir:"🔴 SHORT",prob:"MÉDIA",note:"Extremamente significativo. 180° do LOW absoluto.",seas:"H2 2026"},
  {d:"Aug 27",b:"key",l:"📐 Gann 225° do SH2 Jan",dir:"🔴 SHORT",prob:"MÉDIA",note:"Confluência com Gann 180° LOW no dia anterior.",seas:"H2 2026"},
  {d:"Aug 28",b:"key",l:"🌕 LC Peixes 9°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Confusão/dissolução narrativa.",seas:"H2 2026"},
  {d:"Sep 04",b:"conf",l:"⭐⭐⭐ RALLY TOP FIXED — ATH+333 = LOW+189 = 3×63 Gann",dir:"🔴 SHORT",prob:"ALTA",note:"DATA FIXA. Exit all longs. Preparação Fall Crash Zone.",seas:"H2 2026"},
  {d:"Sep 11",b:"key",l:"🌑 LN Virgem 23° (QE Peak inversion)",dir:"🟡 WATCH",prob:"MÉDIA",note:"Virgem = peak QE. Em bear = TOPO local. Confirma exit.",seas:"H2 2026"},
  {d:"Sep 16",b:"key",l:"📐 Gann 345° do ATH",dir:"🔴 SHORT",prob:"MÉDIA",note:"15° antes de completar ciclo anual.",seas:"H2 2026"},
  {d:"Sep 19",b:"key",l:"📐 Gann 225° do SL2 Feb",dir:"🔴 SHORT",prob:"MÉDIA",note:"Preparação Fall Crash.",seas:"H2 2026"},
  {d:"Sep 27",b:"key",l:"🌕 LC Áries 15°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Áries = Marte = agressividade. Full Moon = topo em bear.",seas:"H2 2026"},
  {d:"Oct 01",b:"key",l:"📐 Gann 360° do ATH — Ciclo Anual Completo",dir:"🔴 SHORT",prob:"MÉDIA",note:"1 ano exacto desde ATH. Ponto de reset maior.",seas:"H2 2026"},
  {d:"Oct 02",b:"key",l:"📐 Gann 315° SL1 Nov (Swing Low)",dir:"🔴 SHORT",prob:"MÉDIA",note:"",seas:"H2 2026"},
  {d:"Oct 06",b:"conf",l:"⭐⭐⭐ MARIE STANTON BIRTHDAY — 1 ano do ATH",dir:"🔴 SHORT",prob:"ALTA",note:"Tunnel Gann: \'Fim da fase Marie = topo do mercado\'. 1 ano exacto.",seas:"H2 2026"},
  {d:"Oct 07-10",b:"conf",l:"⚠️⚠️⚠️ FALL CRASH ZONE — Perigee max force lag 0d + K of Hearts #9 + LN Balança",dir:"🔴 SHORT",prob:"ALTA",note:"JANELA DE CRASH CONFIRMADA por 3 frameworks. Alvo $35-44K cycle bottom.",seas:"H2 2026"},
  {d:"Oct 11",b:"key",l:"🌑 LN Balança 28°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Balança = valores em equilíbrio quebrado.",seas:"H2 2026"},
  {d:"Oct 20",b:"key",l:"Vénus □ Plutão exact",dir:"🔴 SHORT",prob:"MÉDIA",note:"Valores destruídos/transformados.",seas:"H2 2026"},
  {d:"Oct 26",b:"key",l:"☀️ Sol □ Plutão 0.00° EXACTO",dir:"🔴 SHORT",prob:"MÉDIA",note:"Crise estrutural absoluta. Precisão rara.",seas:"H2 2026"},
  {d:"Nov 04",b:"key",l:"♀ Vénus ⚹ Júpiter 0.03° (99 ciclos Pesavento)",dir:"🟢 LONG",prob:"MÉDIA",note:"Aspecto mais bullish. Se pós Crash Zone = bottom + rally.",seas:"H2 2026"},
  {d:"Nov 09",b:"key",l:"🌑 LN Escorpião 19°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Escorpião = LOW absoluto 730 ciclos Pesavento.",seas:"H2 2026"},
  {d:"Nov 16",b:"key",l:"♂♃ Marte ☌ Júpiter 0.09°",dir:"🟢 LONG",prob:"MÉDIA",note:"Acção + expansão = arranque bullish forte.",seas:"H2 2026"},
  {d:"Nov 24",b:"key",l:"📐 Gann 270° do LOW $60,001",dir:"🔴 SHORT",prob:"MÉDIA",note:"270° = ⅜ do ciclo anual desde LOW. Turning point.",seas:"H2 2026"},
  {d:"Nov 28-29",b:"conf",l:"♀ Vénus ⚹ Júpiter EXACTO 0.00° + ♅ Urano △ Plutão",dir:"🟢 LONG",prob:"MÉDIA",note:"Confluência extrema bullish + generational aspect.",seas:"H2 2026"},
  {d:"Dec 01-11",b:"key",l:"⭐⭐⭐ URANO △ PLUTÃO — Aspecto Generacional",dir:"🟡 WATCH",prob:"MÉDIA",note:"Ambos exactos 29 Nov 0.01°. Generational shift. Última vez foi 1922. Reset estrutural completo.",seas:"H2 2026"},
  {d:"Dec 04",b:"key",l:"♂♅ Marte □ Urano 0.12°",dir:"🔴 SHORT",prob:"MÉDIA",note:"Disrupção. Volatilidade.",seas:"H2 2026"},
  {d:"Dec 09",b:"key",l:"🌑 LN Sagitário 22°",dir:"🟡 WATCH",prob:"MÉDIA",note:"Sagitário = optimismo. Bear inversion = topo local.",seas:"H2 2026"},
  {d:"Dec 18",b:"key",l:"📐 Gann 315° SL2 Feb + Solstício Inverno",dir:"🔴 SHORT",prob:"MÉDIA",note:"315° do swing low + solstício = ponto astro-time major.",seas:"H2 2026"},
  {d:"Dec 23",b:"key",l:"☀️ Sol □ Neptuno 0.02°",dir:"🔴 SHORT",prob:"MÉDIA",note:"Precisão rara. Confusão máxima end of year.",seas:"H2 2026"},
  {d:"Dec 25",b:"key",l:"📐 Gann 345° SH2 Jan",dir:"🟡 WATCH",prob:"MÉDIA",note:"",seas:"H2 2026"},
  {d:"Dec 29-30",b:"key",l:"☀️ Sol □ Saturno + ☿ □ Saturno",dir:"🔴 SHORT",prob:"MÉDIA",note:"Duplo bearish end of year.",seas:"H2 2026"}
];
...
// ── WEEK VIEW DATA ──────────────────────────────────────────
const WEEK_DATA = {
  weekLabel: "Mai 22 – Jun 30, 2026 · HOJE: Mai 22",
  seasonal: "Sell in May activo até 26 Jun · Summer Rally arranca 26-30 Jun · Fall Crash Zone Set-Out",
  btcRef: 77400,
  tops: [{price:73807,label:"p1 — 11 Abr",n:114},{price:76127,label:"p2 — 14 Abr",n:108},{price:78553,label:"p3 — 23 Abr",n:104},{price:81500,label:"p4 — 15 Mai",n:97}],
  s144levels: [
    {n:96,price:82091,type:"resist",label:"96/144 — TECTO 7 falhas"},
    {n:102,price:79330,type:"resist",label:"102/144 — resistência recente"},
    {n:108,price:76569,type:"resist",label:"108/144 — pivot line"},
    {n:114,price:73807,type:"support",label:"114/144 — alvo break"},
    {n:120,price:71046,type:"support",label:"120/144 — suporte médio"},
    {n:126,price:68285,type:"support",label:"126/144 — alvo grande"},
    {n:132,price:65524,type:"support",label:"132/144 — capitulação"},
    {n:144,price:60001,type:"major",label:"144/144 — LOW original"},
  ],
  phases:[
    {label:"FASE 1: Cluster Bearish Maio",days:"22-29 Mai",icon:"🔴",color:"#ff4060",note:"Sol☌Urano (22), Marte□Plutão (26), Gann 90° do LOW (28), Vénus□Saturno (29). Alvo: quebra $76,569 → $73,807. 7 falhas na zona $82K = Wyckoff distribution confirmada."},
    {label:"FASE 2: Estabilização",days:"2-8 Jun",icon:"🟡",color:"#ffc832",note:"Sol⚹Saturno inicia estabilização. Range apertado $73-78K. Preparação para o pivot maior."},
    {label:"FASE 3: PIVOT Vénus☌Júpiter",days:"9-15 Jun",icon:"🟢",color:"#50e878",note:"Vénus☌Júpiter 9 Jun 20:00 UTC — 99 ciclos Pesavento. LN Gémeos 15 Jun. Bounce mid-W. Alvo $80-85K. Ponto de viragem local."},
    {label:"FASE 4: Higher Low + Launch",days:"21-30 Jun",icon:"⭐",color:"#c8b060",note:"Gann 135° SL2 + Solstício (21). Vénus△Saturno EXACTO 0.002° (25). Fim Sell in May (26). Marte⚹Júpiter (28). Dia 144 swing square (30). Second foot do W. Launch Summer Rally."},
  ],
  aspects: [
    {d:"Mai 22",wd:"Sex",aspect:"Sol ☌ Urano 0.09° + Vénus □ Neptuno + Mercúrio ⚹ Saturno",icon:"🔴",
     bias:"pivot",tag:"HOJE — Cluster de alta volatilidade",
     note:"HOJE. BTC $77,400. Sol☌Urano quase exacto = disrupção/surpresa. Vénus□Neptuno = activos sobrevalorizados. Mercúrio⚹Saturno = comunicação realista. Mistura tensa. 7ª falha na zona $82K confirma distribuição Wyckoff Fase C/D. Suporte $76K aguentou 2 testes esta semana.",
     s144:"Zona actual $77,400 entre 108/144 ($76,569) e 96/144 ($82,091). Range apertado. Break de $76,569 → alvo $73,807 (114/144)."},
    {d:"Mai 26",wd:"Ter",aspect:"Marte □ Plutão 0.26° + Sol △ Plutão 0.15°",icon:"🔴🔴",
     bias:"bear",tag:"Aspecto mais violento da janela",
     note:"Marte□Plutão = confronto de forças. Força irresistível contra objecto imóvel. O aspecto mais violento das próximas 4 semanas. Sol△Plutão simultâneo pode dar poder positivo ao movimento — mas em contexto bearish = descarga. Precedente: geopolítico ou financeiro pesado.",
     s144:"Provável break test de $76,569 (108/144). Se quebrar com força → $73,807 rapidamente."},
    {d:"Mai 28",wd:"Qui",aspect:"Gann 90° do LOW $60,001",icon:"🔴",
     bias:"bear",tag:"Turning point 1ª ordem",
     note:"90 dias exactos desde o LOW absoluto $60,001 (27 Fev). Ângulo Gann de 1ª ordem = turning point OU aceleração. Com contexto bearish em curso, mais provável aceleração da queda que reversão. Confluência: Vénus□Saturno amanhã.",
     s144:"Data crítica. Watch $76,000 (defesa múltipla). Break = queda rápida para $73-74K."},
    {d:"Mai 29",wd:"Sex",aspect:"Vénus □ Saturno 0.41° + Gann 135° SH2",icon:"🔴",
     bias:"bear",tag:"Duplo bearish",
     note:"Vénus□Saturno = valores contraídos, dinheiro restrito, activos sob pressão. Gann 135° do swing high de Janeiro simultâneo. Duplo hit: aspecto astro bearish + ângulo Gann. Final da janela bearish de Maio.",
     s144:"Fim da primeira janela. Se BTC segurar $76K, o cluster falhou. Se romper → confirma bear."},
    {d:"Jun 02-03",wd:"Ter-Qua",aspect:"Sol ⚹ Saturno",icon:"🟡",
     bias:"neut",tag:"Primeira estabilização",
     note:"Sol⚹Saturno = estrutura, estabilização, disciplina. Depois do cluster bearish de Maio, este é o primeiro sinal de estabilização. Não é bullish — é pausa. Preço deve consolidar entre $73-78K esperando o próximo pivot.",
     s144:"Consolidação lateral. Zona de acumulação para o pivot de 9-15 Jun."},
    {d:"Jun 04",wd:"Qui",aspect:"Mercúrio □ Neptuno 0.76°",icon:"🟡",
     bias:"neut",tag:"Narrativa confusa",
     note:"Mercúrio□Neptuno = notícias contraditórias, decisões ambíguas. Não é bearish nem bullish — é indefinição. Preparação para o evento principal de 9 Jun.",
     s144:"Range apertado esperado. Sem direcção clara."},
    {d:"Jun 09",wd:"Ter",aspect:"⭐ VÉNUS ☌ JÚPITER 20:00 UTC (0.32°)",icon:"🟢🟢",
     bias:"bull",tag:"PIVOT MAIOR — 99 ciclos",
     note:"O ASPECTO MAIS BULLISH da astrologia financeira. 99 ciclos verificados por Pesavento. Vénus (dinheiro) + Júpiter (expansão) = combustível bullish. EXACTO 20:00 UTC (16:00 EDT). Provável fundo local. Início do bounce mid-W.",
     s144:"Se BTC caiu para $70-73K, entry LONG aqui. Alvo do bounce: $80-85K."},
    {d:"Jun 15",wd:"Seg",aspect:"🌑 LN GÉMEOS 02:54 UTC",icon:"🟢",
     bias:"bull",tag:"5 frameworks convergem",
     note:"Lua Nova em Gémeos exacta. Pesavento 730 ciclos: pivot MAJOR. Gémeos é agora signo de Úrano (ingressou 26 Abr). Vénus⚹Urano simultâneo. Se preço já em fase bullish (pós Vénus☌Júpiter), esta LN confirma o pivot para cima.",
     s144:"Ponto de confirmação. Watch $80-82K resistência. Break = confirmação de rally."},
    {d:"Jun 21",wd:"Dom",aspect:"Gann 135° do SL2 Feb + Solstício",icon:"🟡",
     bias:"neut",tag:"Solstício + Gann",
     note:"135° do swing low de 6 Fev (SL2 $92K). Solstício de Verão simultâneo. Ponto de turning potencial. Se o bounce já esgotou (mid-W peak completo), esta é a data para reverter para o segundo pé da W.",
     s144:"Watch o topo do bounce. Reversão possível para $70-73K (higher low do W)."},
    {d:"Jun 25",wd:"Qui",aspect:"⚡ VÉNUS △ SATURNO 0.002° (EXACTO)",icon:"🟢",
     bias:"bull",tag:"Precisão rara ao milésimo",
     note:"EXACTO ao milésimo (0.002°) — precisão rara e significativa. Vénus△Saturno = valores ganham estrutura sólida, dinheiro encontra base real. Sol□Neptuno simultâneo (confusão) = as duas realidades encontram-se. É a semente de estabilização estrutural.",
     s144:"Base sólida a formar. Zona ideal para higher low se em pullback."},
    {d:"Jun 26",wd:"Sex",aspect:"Fim Sell in May (Pesavento)",icon:"🟢",
     bias:"bull",tag:"Reversão sazonal",
     note:"Pesavento explicit: 'Sell in May bottoms in early July'. 26 Jun marca o FIM oficial do padrão sazonal bearish. A partir daqui, viés sazonal fica neutro/positivo.",
     s144:"Fim da pressão sazonal. Preparação para o rally de verão."},
    {d:"Jun 28",wd:"Dom",aspect:"Marte ⚹ Júpiter 0.15°",icon:"🟢",
     bias:"bull",tag:"Arranque do próximo ciclo",
     note:"Marte (acção) + Júpiter (expansão) = arranque bullish. Confluência com Vénus△Saturno de 25 Jun e fim de Sell in May de 26 Jun. Base sólida está lançada.",
     s144:"Confirmação para longs de médio prazo. Alvo: $82-90K nas semanas seguintes."},
    {d:"Jun 30",wd:"Ter",aspect:"⭐ Dia 144 do swing square + Mercury retro",icon:"⭐",
     bias:"bull",tag:"Fecho da swing square",
     note:"144 dias exactos desde o swing low de 6 Fev 2026. Fecha a swing square anchor. Mercury station retrograde simultâneo. Second foot do W-formation esperado. Higher low típico.",
     s144:"Higher low expected. Zona $70-73K. Depois launch do Summer Rally."},
  ]
};
  ...
  return (
    <div style={{position:"relative",zIndex:1,maxWidth:740,width:"100%",margin:"0 auto",padding:"0 12px 60px"}}>
      ...
      <div style={{textAlign:"center",marginBottom:16}}>
        ...
        <div style={{fontSize:13,color:"#ffc832",fontWeight:"bold"}}>🔴 BTC $77,400 · Sell in May activo · 7 falhas $82K (Wyckoff distribution) · Suporte $76K aguenta · Pivot 9-15 Jun</div>
      </div>
      ...
      <div style={{marginTop:16,background:"rgba(255,255,255,.02)",border:"1px solid rgba(255,255,255,.04)",borderRadius:6,padding:"12px"}}>
        ...
        <div style={{display:"flex",gap:3,alignItems:"flex-end",justifyContent:"space-around",overflowX:"auto"}}>
          {[
            {d:"22",net:-1,bias:"pivot"},
            {d:"23",net:-1,bias:"bear"},
            {d:"24",net:-2,bias:"bear"},
            {d:"25",net:-2,bias:"bear"},
            {d:"26",net:-4,bias:"bear"},
            {d:"27",net:-3,bias:"bear"},
            {d:"28",net:-3,bias:"bear"},
            {d:"29",net:-3,bias:"bear"},
            {d:"30",net:-2,bias:"bear"},
            {d:"31",net:-1,bias:"neut"},
            {d:"1",net:0,bias:"neut"},
            {d:"2",net:1,bias:"neut"},
            {d:"3",net:1,bias:"neut"},
            {d:"4",net:0,bias:"neut"},
            {d:"9",net:3,bias:"bull"},
            {d:"15",net:2,bias:"bull"},
            {d:"25",net:3,bias:"bull"},
            {d:"28",net:2,bias:"bull"},
          ].map((day,i)=>{
